...
extension XCTestCase {
    ...
    ///
    /// Use this function to disable password autofill by navigating to the iOS settings app and turning off the password autofill functionality in the settings UI.
    ///
    ...
    /// We recommend using `if #available(iOS 17.2, *) { /* ... */ }` to skip password-related functionality in your UI tests until there is a better workaround.
